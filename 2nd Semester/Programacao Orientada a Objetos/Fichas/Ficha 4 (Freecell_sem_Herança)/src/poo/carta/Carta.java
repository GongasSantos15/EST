...
/**
 * Representa uma carta de jogar, com face e naipe. Tem ainda uma posição
...
public class Carta {
    ...
    /**
     * Define se carta deve estar virada para cima ou baixo 
     ...
     * @return trua = virada para cima, false = virada para baixo
     */
    ...
    /**
     * indica se a carta está seleccionada 
     * @return true, se carta está seleccionada
     */
    ...
    public boolean estaDentro( Point pt ) {
    	 // para estar dentro a coordenada tem de estar entre o x e x+comp e y e y+alt
