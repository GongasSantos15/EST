...
public class Baralho {
	 ...
	 * @param comp comprimento (em pixéis) de cada carta
	 * @param alt altura (em pixéis) de cada carta
	 * @param fichCartas ficheiro de imagem onde estão definidos os desenhos das cartas
	 * @param costas índice da imagem a utilizar para as costas da carta
	 */
	 ...
	 * @return true = há mais cartas, false = não há mais cartas
	 */
    ...
    // método para auxiliar na leitura de um ficheiro de imagem
