				...
				if($pode){
					...
					while($row = mysqli_fetch_array($retval)){
						...
						if($row["tipoUtilizador"] == CLIENTE_NAO_VALIDO)
							echo"	<td><a href='validar.php?IdUser=".$row["nomeUtilizador"]."' ><img src='../../media/imgs_sistema/validar.png' width=50 height=50></a></td>";
						else
							echo"<td></td>";
						//EDITAR
						if($row["tipoUtilizador"] != CLIENTE_APAGADO){
							echo"	<td><a href='preparaEditar.php?IdUser=".$row["nomeUtilizador"]."' ><img src='../../media/imgs_sistema/editar.png' width=50 height=50></a></td>";
						}else
							echo"<td></td>";
						//PROMOVER
						if($row["tipoUtilizador"] != ADMINISTRADOR)
							echo "<td><a href='PgPromover.php?IdUser=".$row["nomeUtilizador"]."' ><img src='../../media/imgs_sistema/promover.png' width=50 height=50></a></td>";
						else
							echo"<td></td>";
